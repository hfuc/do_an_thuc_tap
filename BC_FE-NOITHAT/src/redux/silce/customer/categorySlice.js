  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchAllCategory.pending, (state, action) => {
        ...
        state.categoryLivingRoom = [];
        state.categoryDiningRoom = [];
        state.categoryBedRoom = [];
        state.isError = false;
      })
      .addCase(fetchAllCategory.fulfilled, (state, action) => {
        state.categoryLivingRoom = action.payload.category_living_room;
        state.categoryDiningRoom = action.payload.category_dining_room;
        state.categoryBedRoom = action.payload.category_bed_room;
