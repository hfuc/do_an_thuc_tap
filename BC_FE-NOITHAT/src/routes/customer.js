...
import CategoryLivingRoom from "../pages/customer/CategoryLivingRoom";
import CategoryDiningRoom from "../pages/customer/CategoryDiningRoom";
import CategoryBedRoom from "../pages/customer/CategoryBedRoom";
...
const CustomerRoute = (props) => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/category_living_room/:category_id"
        element={<CategoryLivingRoom />}
      />
      <Route
        path="/category_dining_room/:category_id"
        element={<CategoryDiningRoom />}
      />
      <Route
        path="/category_bed_room/:category_id"
        element={<CategoryBedRoom />}
      />
